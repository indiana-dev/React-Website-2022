...
export default function ProjectLandscape({
    ...
    return <div>
        <AnimatedImage project={project} start={0} end={1.4} size={0.8} left={0.1}  src="assets/images/landscape/ls0.png" />
        <AnimatedImage project={project} start={0.4} end={1.4} size={0.6} src="assets/images/landscape/ls1.png" />
        <AnimatedImage project={project} start={0.75} end={1.4} size={0.6} right={0.1} src="assets/images/landscape/ls1.png" />
